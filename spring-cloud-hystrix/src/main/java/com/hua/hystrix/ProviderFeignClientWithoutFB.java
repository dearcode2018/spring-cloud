...
configuration = FeignConfig4Provider.class, contextId = "c2"
...
public interface ProviderFeignClientWithoutFB
{
	 ...
	 * @author qianye.zheng
	 */
	static class ProviderFallback implements ProviderFeignClientWithoutFB
	{
		/**
		 * @description 
		 * @param content
	 ...
	 */
	@Component
	static class ProviderFallbackFactory implements FallbackFactory<ProviderFeignClientWithoutFB>
	{
		/**
		 * @description 
		 * @param cause
		 ...
		 */
		@Override
		public ProviderFeignClientWithoutFB create(Throwable cause)
		{
			
			return new ProviderFeignClientWithoutFB() {
				/**
				 * @description 
				 * @param content
				 * @return
